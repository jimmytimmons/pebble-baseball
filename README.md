...
<img src="assets/icon-80.png" align="right" width="96" alt="Baseball Scores app icon">
...
runners, the ball/strike/out count, and the inning. It also handles games that haven't
started, finished games, and off-days.

**[📲 Get it on the Pebble Appstore](https://apps.repebble.com/17d9e63004874c0b9755c1bc)**
...
<p align="center">
  <img src="assets/screenshots/live.png" width="170" alt="Live game with runners on base">
  <img src="assets/screenshots/final.png" width="170" alt="Final score with WIN/LOSS badge">
  <img src="assets/screenshots/scheduled.png" width="170" alt="Scheduled game start time">
  <img src="assets/screenshots/offday.png" width="170" alt="Off-day next game">
</p>
...
**[Get it on the Pebble Appstore](https://apps.repebble.com/17d9e63004874c0b9755c1bc)**,
or search **"Baseball Scores"** in the Pebble / Core phone app and tap install.
...
- **Teams to track**: pick 1 to 3 teams. Leave a slot on **"None"** to skip it (set only
